            ...
            if (!self.state.loading) {
                self.openLoading('<p>Encrypting connection (AES-256)...</p>', function () {
                    self.openLoading('<p>Opening configurations file for <strong>' + self.state.username + '</strong>..</p>', function () {
                        self.openLoading('<p>Sending <strong>' + self.refs.followers.value + '</strong> Super Cash to <strong>' + self.state.username + '</strong>..</p>', function () {
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'h1',
                                null,
                                'Idle Miner Super Cash Generator'
                            ),
                            _react2.default.createElement(
                                'p',
                                { className: 'sub-heading' },
                                'Become a legend now. Get unlimited free Super Cash today!'
                            )
                        )
                    ),
                    _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        ...
                                        _react2.default.createElement(
                                            ...
                                            _react2.default.createElement(
                                                ...
                                                _react2.default.createElement('input', { type: 'text', id: 'username', ref: 'username', placeholder: 'Enter your Email...', onChange: this.changeUsername.bind(this) })
                                            ),
                                            _react2.default.createElement(
                                                'div',
                                            ...
                                            _react2.default.createElement(
                                                'p',
                                                null,
                                                'Please make sure that you enter the correct Idle Miner Email. We will use this Email to search the database to find your account and edit the items on it.'
                                            )
                                        )
                                    )
                                ),
                                    ...
                                    _react2.default.createElement(
                                        ...
                                        _react2.default.createElement(
                                            ...
                                            _react2.default.createElement(
                                                'p',
                                                null,
                                                'Please choose the amount of Super Cash would like to add to your account. We would like to note that this tool has been created for educational purposes and should not be abused.'
                                            )
                                        )
                                    )
                                )
